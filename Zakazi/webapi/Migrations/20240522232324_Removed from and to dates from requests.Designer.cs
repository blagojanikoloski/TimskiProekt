...
namespace webapi.Migrations
{
    ...
    [Migration("20240522232324_Removed from and to dates from requests")]
    partial class Removedfromandtodatesfromrequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessZakaziUser", b =>
                {
                    ...
                    b.HasKey("BusinessesBusinessId", "EmployeesId");
            ...
            modelBuilder.Entity("webapi.Domain.Models.Business", b =>
                {
            ...
            modelBuilder.Entity("webapi.Domain.Relations.PostRequests", b =>
                {
                    b.Property<int>("PostId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusinessZakaziUser", b =>
                {
                    ...
                    b.HasOne("webapi.Domain.Models.ZakaziUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("webapi.Domain.Models.UserRole", b =>
                {
                    ...
                    b.HasOne("webapi.Domain.Models.ZakaziUser", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("webapi.Domain.Relations.PostRequests", b =>
                {
                    b.HasOne("webapi.Domain.Models.Post", null)
                        .WithMany()
